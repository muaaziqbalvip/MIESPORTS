            ...
            Column(modifier = Modifier.padding(horizontal = 20.dp)) {
                ...
                GlassCard(modifier = Modifier.fillMaxWidth(), borderColor = NeonGreen.copy(alpha = 0.4f)) {
                    Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        if (reveal != null) {
                            Spacer(Modifier.height(8.dp))
                            Text("Room ID: ${reveal["roomId"]}", color = TextPrimary, style = MaterialTheme.typography.titleMedium)
                            Text("Password: ${reveal["roomPassword"]}", color = TextPrimary, style = MaterialTheme.typography.titleMedium)
                        } else {
